...
export default function SurveyView() {
  ...
  return (
    ...
    >
      ...
      {!loading && (
        // <div className="flex">
        //   <div className="columns-sm shadow sm:overflow-hidden sm:rounded-md pr-1">
        //     <div className="space-y-6 bg-white px-4 py-4 sm:p-6 min-h-screen">
        //       <div className="py-2 px-3 rounded fixed left-40 bottom-4 z-50 animate-fade-in-down">
        //         <DragElements />
        //       </div>
        //     </div>
        //   </div>
